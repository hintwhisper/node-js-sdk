...
Api.prototype.request = function(fn, requestUrl, params, callback) {
    console.log('logging the requestUrl object the request ........... ');
    ...
    var token = params.token,
        ...
        that = this;
    console.log('logging after processing the requst url ');
    console.dir(url);
    fn(
        url,
        opts,
...
Api.prototype.get = function (requestUrl, token, qs, callback) {
    ...
    console.log('loggin the params from teh api.get function ----------------------');
    console.log(params);
    console.log('loggin the reuqest url from teh api.get function.......');
    console.log(requestUrl);
    console.log('logging this from the logs.............');
    console.log(this);
    var _this = this;
    this.request.call(_this, request.get, requestUrl, params, callback);
};
...
Api.prototype.post = function (requestUrl, token, body, qs, callback) {
    ...
    this.request.call(this, request.post, requestUrl, params, callback);
};
...
Api.prototype.del = function (requestUrl, token, qs, callback) {
    ...
    this.request.call(this, request.del, requestUrl, params, callback);
};
...
Api.prototype.put = function (requestUrl, token, body, callback) {
    ...
    this.request.call(this, request.put, requestUrl, params, callback);
};
